<template lang="">
    <div id="introCarousel-222" class="carousel slide carousel-fade shadow-2-strong" data-mdb-ride="carousel">
  
  <ol class="carousel-indicators">
    <li data-mdb-target="#introCarousel-222" data-mdb-slide-to="0" class="active"></li>
    <li data-mdb-target="#introCarousel-222" data-mdb-slide-to="1"></li>
    <li data-mdb-target="#introCarousel-222" data-mdb-slide-to="2"></li>
  </ol>
