              ...
              <div class="row h-100 align-items-center">
                  ...
                  >
                      ...
                      <div class="post-content">
                          <p class="tag " style="background-color:red;color:white"><span >Sport</span></p>
  ...
  <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
              ...
              <div class="row justify-content-center">
                  ...
                  <div class="col-12 col-lg-8">
                      <div class="intro-news-tab">
                          ...
                          <div class="intro-news-filter d-flex justify-content-between" style="background-color:red">
                              <h6 class="fw-bold"  style="background-color:red;color:white">Sport news</h6>
                              <nav>
                                  <div class="nav nav-tabs" id="nav-tab" role="tablist"  style="background-color:white">
                                      ...
                                      <a class="nav-item nav-link fw-bold" href="https://welcome.ufcfightpass.com/region/row" target="_blank"  aria-selected="false">UFC</a>
                                      <a class="nav-item nav-link fw-bold" id="nav3" data-toggle="tab" href="" role="tab" aria-controls="nav-3" aria-selected="false">EVENTS</a>
                                      <a class="nav-item nav-link fw-bold"  href="https://www.uefa.com/" target="_blank"   aria-selected="false">FOOTBALL</a>
   ...
   <div class="tab-content" id="nav-tabContent">
                              ...
                              <div class="col-12" 
                                      ...
                                      <img v-else src="https://nzsportcollective.co.nz/wp-content/uploads/2023/05/NZSCC-montage.jpg" alt="">
                                  </a>
                                              </div>
   ...
   <div class="col-12 col-sm-9 col-md-6 col-lg-4" style="background-color:black;color:white">
                    ...
                    :key="item">
                          ...
                          <div class="single-widget-area add-widget " >
                            <br/>
                            <h5 class="text-center" style="background-color:black;color:white;"><a style="color:red;font-size:30px" class="fw-bold" :href="item.url" target="_blank">{{item.title}}</a></h5>
  ...
  export default {
    ...
    methods: {
          ...
          async getData3() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&CategoryId=10&Language=14&Page=3&PageSize=${pageSize}`
              );
              const data = await response.json();
              return data.items;
            } catch (error) {
          ...
          async getData4() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&CategoryId=10&Language=14&Page=5&PageSize=${pageSize}`
              );
              const data = await response.json();
              return data.items;
            } catch (error) {
          ...
          async getData5() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&CategoryId=10&Language=14&Page=6&PageSize=${pageSize}`
              );
              const data = await response.json();
              return data.items;
            } catch (error) {
      ...
      .catagory-featured-post.bg-overlay {
  background-image: url('https://native-english.com.ua/wp-content/uploads/2017/10/original.jpg'); /* Установите вашу картинку */
