<template lang="">
    ...
    <!-- /src/img/bg-img/10.jpg -->
        ...
        <!-- ##### Video Area Start ##### -->
        <section class="video-area bg-img bg-overlay bg-fixed" style="background-image: url(' https://online.vu.edu.au/sites/default/files/field/image/Easiest_countries_to_start_a_business_main_image.jpeg');">
            <div class="container">
                <div class="row">
                    <!-- Featured Video Area -->
                   <div class="col-12">
