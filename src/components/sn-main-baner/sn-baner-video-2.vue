<template lang="">
    ...
    <!-- /src/img/bg-img/10.jpg -->
        ...
        <!-- ##### Video Area Start ##### -->
        <section class="video-area bg-img bg-overlay bg-fixed" style="background-image: url('https://static.wixstatic.com/media/7ec876_093eeaa665f14417ada621163711acf5~mv2.jpg/v1/fit/w_2500,h_1330,al_c/7ec876_093eeaa665f14417ada621163711acf5~mv2.jpg');">
            <div class="container">
                <div class="row">
                    <!-- Featured Video Area -->
                   <div class="col-12">
