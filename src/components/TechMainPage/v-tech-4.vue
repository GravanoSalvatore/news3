<template lang="">
  ...
  <!-- /src/img/bg-img/10.jpg -->
      ...
      <!-- ##### Video Area Start ##### -->
      <section class="video-area bg-img bg-overlay bg-fixed" style="background-image: url(' https://www.netscribes.com/wp-content/uploads/2019/06/Technology-Watch.jpg');">
          <div class="container">
              <div class="row">
                  <!-- Featured Video Area -->
                 <div class="col-12">
