  ...
  <div class="carousel-inner">
      ...
      <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-white text-center">
            <router-link to="/Tech" > <h1 class="mb-3 text-secondary">Technology</h1></router-link>
            <h5 class="mb-4"></h5>
            <!-- <a
    ...
    <div class="carousel-item">
      <div class="mask" style="background-color: rgba(0, 0, 0, 0.3);">
        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-white text-center">
            <router-link to="/Science" > <h1 class="mb-3 text-secondary">Science</h1></router-link>
    ...
    <div class="carousel-item">
      ...
      >
        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-white text-center">
            <router-link to="/Business" > <h1 class="mb-3 text-secondary">Business</h1></router-link>
