<template lang="">
    <div></div>
        ...
        <section class="video-area bg-img bg-overlay bg-fixed" style="background-image: url('https://i0.wp.com/businessday.ng/wp-content/uploads/2022/07/healthcare-1.png?fit=700%2C400&ssl=1');">
            <div class="container">
                <div class="row">
                    <!-- Featured Video Area -->
                   <div class="col-12">
