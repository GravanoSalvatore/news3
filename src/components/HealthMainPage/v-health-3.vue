<template lang="">
  <div>
   <div class="catagory-featured-post bg-overlay clearfix" style="background-image: url('https://www.psypost.org/wp-content/uploads/2023/10/exercise-cycling-cognitive-ability.jpg')">
              ...
              <div class="row h-100 align-items-center">
                  ...
                  >
                      ...
                      <div class="post-content">
                          <p class="tag " style="background-color:green;color:white"><span >Health</span></p>
  ...
  <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
              ...
              <div class="row justify-content-center">
                  ...
                  <div class="col-12 col-lg-8">
                      <div class="intro-news-tab">
                          ...
                          <div class="intro-news-filter d-flex justify-content-between" style="background-color:green">
                              <h6 class="fw-bold"  style="color:white">Health news</h6>
                              <nav>
                                  <div class="nav nav-tabs" id="nav-tab" role="tablist"  style="background-color:white">
                                      ...
                                      <a class="nav-item nav-link fw-bold" id="nav2" data-toggle="tab" href="#nav-2" role="tab" aria-controls="nav-2" aria-selected="false">DIETS</a>
                                      <a class="nav-item nav-link fw-bold" id="nav3" data-toggle="tab" href="#nav-3" role="tab" aria-controls="nav-3" aria-selected="false">BLOG</a>
                                      <a class="nav-item nav-link fw-bold" id="nav4" data-toggle="tab" href="#nav-4" role="tab" aria-controls="nav-4" aria-selected="false">RECEPTS</a>
   ...
   <div class="tab-content" id="nav-tabContent">
                              ...
                              <div class="col-12" 
                                      ...
                                      <img v-else src="https://i0.wp.com/calmatters.org/wp-content/uploads/2022/06/ChanelleNibbelink_CalMatters_MentalHealthShuffle_Final1.png?fit=2000%2C1000&ssl=1" alt="">
                                  </a>
                                              </div>
   ...
   <div class="col-12 col-sm-9 col-md-6 col-lg-4" style="background-color:black;color:white">
                    ...
                    :key="item">
                          ...
                          <div class="single-widget-area add-widget " >
                            <br/>
                            <h5 class="text-center" style="background-color:black;"><a style="color:green;font-size:30px" class="fw-bold" :href="item.url" target="_blank">{{item.title}}</a></h5>
