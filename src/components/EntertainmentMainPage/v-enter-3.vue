<template lang="">
  <div>
   <div class="catagory-featured-post bg-overlay clearfix" style="background-image: url('https://www.bsr.org/images/heroes/bsr-mediaentertainment-hero..jpg')">
              ...
              <div class="row h-100 align-items-center">
                  ...
                  >
                      ...
                      <div class="post-content">
                          <p class="tag " style="background-color:indigo;color:white;"><span >Entertainment</span></p>
  ...
  <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
              ...
              <div class="row justify-content-center">
                  ...
                  <div class="col-12 col-lg-8">
                      <div class="intro-news-tab">
                          ...
                          <div class="intro-news-filter d-flex justify-content-between" style="background-color:indigo">
                              <h6 class="fw-bold"  style="color:white">Entertainment news</h6>
                              <nav>
                                  <div class="nav nav-tabs" id="nav-tab" role="tablist"  style="background-color:white">
                                      ...
                                      <a class="nav-item nav-link fw-bold" id="nav2" data-toggle="tab" href="#nav-2" role="tab" aria-controls="nav-2" aria-selected="false">MUSIC&CINEMA</a>
                                      <a class="nav-item nav-link fw-bold" id="nav3" data-toggle="tab" href="#nav-3" role="tab" aria-controls="nav-3" aria-selected="false">ARTICLES</a>
                                      <a class="nav-item nav-link fw-bold" id="nav4" data-toggle="tab" href="#nav-4" role="tab" aria-controls="nav-4" aria-selected="false">BLOG</a>
   ...
   <div class="tab-content" id="nav-tabContent">
                              ...
                              <div class="col-12" 
                                      ...
                                      <img v-else src="https://www.caesars.com/content/cet-global/caesars-com/las-vegas/shows/_jcr_content/additional_featured_items/cetfeatureditem_160207479/image.stdimg.hd.l.jpg/1696026561017.jpg" alt="">
                                  </a>
                                              </div>
  ...
  <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
   ...
   <div class="col-12 col-sm-9 col-md-6 col-lg-4" style="background-color:indigo;color:white">
                    ...
                    :key="item">
                          ...
                          <div class="single-widget-area add-widget " >
                            <br/>
                            <h5 class="text-center" style="background-color:indigo;"><a   style="color:white;font-size:30px;" class="fw-bold" :href="item.url" target="_blank">{{item.title}}</a></h5>
                            <div class="single-widget-area newsletter-widget mb-10" style="background-color:indigo;color:white">
  ...
  <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                                      ...
                                      <a  :href="item.url" target="_blank" class="post-title cont fw-bold" style="background-color:indigo;color:white">{{item.title}}</a>
                                      <!-- <a style="color:white" v-if="item.author" href="#" class="post-author">author:{{item.author}}</a>
                                                 <a style="color:white" v-else href="#" class="post-author">author:Mr X</a>
                                  -->
